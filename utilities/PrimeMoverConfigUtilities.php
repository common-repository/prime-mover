...
{        
    ...
    protected function updateSiteAndHomeUrLWpConfigHelper($site_url = '', $home_url = '')
    {
        ...
        $config_transformer = $this->getConfigTransformer(true);
     ...
     * @param boolean $custom_config_file_check
     ...
     */
    public function getConfigTransformer($custom_config_file_check = false)
    {
        $instance = null;
        ...
        if ($custom_config_file_check && false === apply_filters('prime_mover_is_config_usable', false)) {
            return $instance;
        }
